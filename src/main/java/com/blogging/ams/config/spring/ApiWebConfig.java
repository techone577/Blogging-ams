package com.blogging.ams.config.spring;


import com.blogging.ams.config.surpport.JsonMapperArgumentResolver;
...
@EnableWebMvc
@ComponentScan(basePackages = "com.blogging.ams.web.api")
